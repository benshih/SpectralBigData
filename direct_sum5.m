...
%%% increasing step function. This version is with the new data set.
...
for j = 1:MAXCLUSTER
    ...
    for i = 1:MAXCLUSTER
        ...
        vTimesMat = Vi^-1 * matTimesVj(firsti:lasti, :);
